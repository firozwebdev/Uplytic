...
export class PDFExporter {
  ...
  async exportDashboard(api, stats, logs, insights, costImpact) {
    ...
    container.innerHTML = this.generatePDFContent(api, stats, logs, insights, costImpact);
  ...
  generatePDFContent(api, stats, logs, insights, costImpact) {
    ...
    return `
      ...
      <div class="recent-activity" style="margin-bottom: 30px;">
        <h2 style="color: #1f2937; font-size: 24px; margin-bottom: 20px; border-bottom: 1px solid #e5e7eb; padding-bottom: 10px;">Recent Activity (Last 20 Checks)</h2>
